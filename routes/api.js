...
var creatorList = ['@Iqbal','@Iqbalgans','@Iqbalm','@iqbalr', '@Iqbalganssss','@Iqbalganteng','@Iqbalgantengg', '@Iqbal'];
...
loghandler = {
    notparam: {
        ...
        getApikey: 'gak punya apikey? chat aku aja yaaa di wa.me/6281315995628 , apikey nya gratis kok'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
...
var len = 15
        ...
        var randomTextNumber = random+randomlagi+'---------IqbalGanteng'+'IQBAL--GANS';
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'IqbalM') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'IqbalM') return res.json(loghandler.invalidKey)
